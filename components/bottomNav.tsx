...
const BottomNav = () => {
     ...
     return (
          <section className="fixed left-1/2 transform -translate-x-1/2 bottom-3 w-[92%] glass h-[4.65em] flex items-center justify-center text-sm shadow-2xl rounded-[20px]">
