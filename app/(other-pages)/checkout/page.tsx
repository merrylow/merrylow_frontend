...
// import { InitializePayment } from 'react-paystack/libs/types'
...
//      amount: 20000, //Amount is in the country's lowest currency. E.g Kobo, so 20000 kobo = N200 (amount * 10ps)
...
// //               <button
// //                   className='w-full h-11 px-7 font-bold text-[15px] btn'
// //                   type='submit'
// //                   onClick={() => {
